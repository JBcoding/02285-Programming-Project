...
public class BDI {
    public static void main(String[] args) {
        /*
            ...
            4.   B := brf(B,ρ);        // brf (B, ρ) is your updated beliefs based on current beliefs B and percept ρ.
            5.   I := deliberate(B);   // deliberate(B) is the set of intentions chosen based on current beliefs B.
            6.   π := plan(B,I);       // plan(B,I) is the plan chosen based on current beliefs B and current intentions I.
            7.   execute(π)            // the procedure executing π
            8. end while
        */
        /*
            1. load level
